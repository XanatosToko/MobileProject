...
public class YouTubePlayerSupportFragmentX  extends Fragment implements Provider {
    ...
    public void onCreate(Bundle var1) {
        super.onCreate(var1);
        this.b = var1 != null ? var1.getBundle("YouTubePlayerSupportFragmentX.KEY_PLAYER_VIEW_STATE") : null;
    }
    ...
    public void onSaveInstanceState(Bundle var1) {
        ...
        var1.putBundle("YouTubePlayerSupportFragmentX.KEY_PLAYER_VIEW_STATE", var2);
    }
